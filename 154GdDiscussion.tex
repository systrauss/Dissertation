...
where $\epsilon_{i}$ are the efficiencies of the electrons and gammas respectively. $C_{\angle}$ is the angular correction for this particular transition, discussed in Chapter \ref{ch:analysis}. Here, it is multiplied, and not divided, so it can be subtracted from the uncorrected area.
